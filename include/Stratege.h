...
public:
    ...
    */
    ...
    static bool GetNewSingleResultByArea(const std::vector<int>& area_vector,const Calculate::CoinsAreaMap_t& bet_map,unsigned int& cur_sys_golden_out,unsigned int& cur_sys_silver_out);
